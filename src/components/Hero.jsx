    ...
    <>
      ...
      >
        ...
        <div className="w-full">
          ...
          >
            <div className="relative min-h-[85vh] flex flex-col justify-center px-4 sm:px-6 lg:px-8">
              <div className="max-w-7xl mx-auto w-full">
                ...
                >
                  ...
                  {/* Features Grid */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    {[
                      {
